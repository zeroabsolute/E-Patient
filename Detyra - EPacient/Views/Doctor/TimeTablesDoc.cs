...
namespace Detyra___EPacient.Views.Doctor {
    class TimeTablesDoc {
        ...
        private DoctorTimetablesController controller;
        ...
        public TimeTablesDoc(Panel previousPanel) {
            controller = new DoctorTimetablesController(this);
            ...
            this.Panel.Name = "timetablesdocMainPanel";

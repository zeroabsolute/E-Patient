...
namespace Detyra___EPacient.Views.Operator.PatientCharts {
    partial class AddDocsForm {
        ...
        private void InitializeComponent() {
            ComponentResourceManager resources = new ComponentResourceManager(typeof(AddDocsForm));
            ...
            this.docTypesComboBox = new DynamicComboBox(
                cBoxSize,
                cBoxLocation
            );
        ...
        private DynamicComboBox docTypesComboBox;

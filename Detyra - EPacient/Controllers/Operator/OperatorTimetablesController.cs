        ...
        public async void handleTableRowSelection() {
            try {
                ...
                if (selectedRow != null) {
                    ...
                    this.view.MondayStartLabel.Text = workingHours != null ? workingHours.MondayStartTime.ToString("HH:mm") : "";
                    this.view.MondayEndLabel.Text = workingHours != null ? workingHours.MondayEndTime.ToString("HH:mm") : "";
                    this.view.TuesdayStartLabel.Text = workingHours != null ? workingHours.TuesdayStartTime.ToString("HH:mm") : "";
                    this.view.TuesdayEndLabel.Text = workingHours != null ? workingHours.TuesdayEndTime.ToString("HH:mm") : "";
                    this.view.WednesdayStartLabel.Text = workingHours != null ? workingHours.WednesdayStartTime.ToString("HH:mm") : "";
                    this.view.WednesdayEndLabel.Text = workingHours != null ? workingHours.WednesdayEndTime.ToString("HH:mm") : "";
                    this.view.ThursdayStartLabel.Text = workingHours != null ? workingHours.ThursdayStartTime.ToString("HH:mm") : "";
                    this.view.ThursdayEndLabel.Text = workingHours != null ? workingHours.ThursdayEndTime.ToString("HH:mm") : "";
                    this.view.FridayStartLabel.Text = workingHours != null ? workingHours.MondayStartTime.ToString("HH:mm") : "";
                    this.view.FridayEndLabel.Text = workingHours != null ? workingHours.MondayEndTime.ToString("HH:mm") : "";
                    this.view.SaturdayStartLabel.Text = workingHours != null ? workingHours.SaturdayStartTime.ToString("HH:mm") : "";
                    this.view.SaturdayEndLabel.Text = workingHours != null ? workingHours.SaturdayEndTime.ToString("HH:mm") : "";
                    this.view.SundayStartLabel.Text = workingHours != null ? workingHours.SundayStartTime.ToString("HH:mm") : "";
                    this.view.SundayEndLabel.Text = workingHours != null ? workingHours.SundayEndTime.ToString("HH:mm") : "";
                }
